...
#### Cross-Validation 
A cross-validation control variable was used while training further models. This allows for our models to be cross-validated 10 times using a logloss summary function. 
```{r}
